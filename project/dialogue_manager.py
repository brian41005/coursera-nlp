...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        question_vec = question_to_vec(question,
                                       self.word_embeddings,
                                       self.embeddings_dim)

        best_thread = pairwise_distances_argmin(question_vec.reshape(1, -1),
                                                thread_embeddings,
                                                axis=1)[0]
...
class DialogueManager(object):
    ...
    def generate_answer(self, question):
        ...
        if not prepared_question.split():
            return
        ...
        # Goal-oriented part:
            ...
            thread_id = self.thread_ranker.get_best_thread(prepared_question,
                                                           tag)
